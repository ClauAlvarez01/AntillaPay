...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 w-full max-w-md relative p-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">
          {t('nav.login', 'Iniciar Sesión')}
        </h2>
        <p className="text-gray-600 mb-6">
          {t('login.welcome', 'Bienvenido de nuevo')}
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <Input
              ...
              className="h-11 rounded-lg border-gray-300 focus:border-violet-500 focus:ring-violet-500"
              placeholder={t('hero.emailPlaceholder', 'tu@email.com')}
              required
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <Input
                ...
                className="h-11 rounded-lg border-gray-300 focus:border-violet-500 focus:ring-violet-500 pr-10"
                required
              />
              <button
                type="button"
          ...
          <div className="flex items-center gap-2">
            ...
            <label htmlFor="remember" className="text-sm text-gray-600">
              {t('login.rememberMe', 'Recordarme en este dispositivo')}
            </label>
          </div>
          ...
          >
            {isLoading ? <Loader2 className="w-5 h-5 animate-spin" /> : t('nav.login', 'Iniciar Sesión')}
          </Button>
          ...
          <div className="space-y-3">
            ...
            >
              ...
              {t('login.googleLogin', 'Iniciar sesión con Google')}
            </Button>
        ...
        <div className="mt-6 text-center text-sm">
          <span className="text-gray-600">{t('login.noAccount', '¿Nuevo en AntillaPay?')} </span>
